...
def main():
    ...
    # Define base paths
    creeds_base_dir = os.path.join(project_root, "creeds_diseases", "data", "raw_creeds_exports")
    output_base_dir = os.path.join(project_root, "creeds_diseases", "data")
    reports_dir = os.path.join(project_root, "creeds_diseases", "analysis")
    ...
    manual_output_dir = os.path.join(output_base_dir, "manual_signatures_extracted")
    ...
    auto_output_dir = os.path.join(output_base_dir, "automatic_signatures_extracted")
