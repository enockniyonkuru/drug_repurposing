...
3.  Matches the disease name (from the folder) to an official 'disease_id' using
    the processed 'disease_metadata.parquet'.
...
DISEASE_INFO_FILE = os.path.join(BASE_DIR, 'data/drug_evidence/open_targets/disease.parquet')
DRUG_INFO_FILE = os.path.join(BASE_DIR, 'data/drug_evidence/open_targets/known_drug_info_data.parquet')
CMAP_EXPERIMENTS_FILE = os.path.join(BASE_DIR, 'data/drug_signatures/cmap/cmap_drug_experiments_new.csv')
TAHOE_EXPERIMENTS_FILE = os.path.join(BASE_DIR, 'data/drug_signatures/tahoe/tahoe_drug_experiments_new.csv')
