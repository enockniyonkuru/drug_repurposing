#!/usr/bin/env python3
"""
Plot Disease Signature Distributions

Generates six-panel distribution plots for disease signatures showing raw and
z-scored values of log-fold change metrics. Provides visual assessment of
signature quality and consistency across experiments.
"""
...
if __name__ == "__main__":
    input_folder = Path("case_study_endomentriosis/disease_signatures/sirota_lab_disease_signatures")
    output_folder = Path("case_study_endomentriosis/disease_signatures/sirota_lab_disease_signatures_plots")
