...
script_path <- if (length(file_arg)) {
  ...
  file.path(getwd(), "scripts", "execution", "convert_signatures_to_rds.R")
}
...
files_to_convert <- list(
  tahoe = file.path(repo_root, "data", "drug_signatures", "tahoe", "tahoe_signatures_shared_genes_only.RData"),
  cmap = file.path(repo_root, "data", "drug_signatures", "cmap", "cmap_signatures_shared_genes.RData")
)
