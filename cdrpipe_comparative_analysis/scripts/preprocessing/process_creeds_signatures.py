...
def main():
    ...
    # Define base paths
    creeds_base_dir = os.path.join(project_root, "creeds_diseases", "disease_signatures", "CREEDS")
    output_base_dir = os.path.join(project_root, "creeds_diseases", "disease_signatures")
