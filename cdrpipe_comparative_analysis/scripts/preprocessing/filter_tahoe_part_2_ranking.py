#!/usr/bin/env python3
"""
Tahoe Signatures Part 2: Rank Genes

Ranks gene expression values in CMap-compatible format for all Tahoe experiments.
Produces ranked parquet checkpoint ready for RData conversion and analysis.
"""
import os
import gc
import numpy as np
