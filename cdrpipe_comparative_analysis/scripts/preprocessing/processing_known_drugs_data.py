...
# (e.g., /.../cdrpipe_comparative_analysis/scripts/preprocessing)
...
OUTPUT_DATA_DIR = os.path.join(BASE_DIR, 'data/known_drugs')
...
def generate_report(df: pd.DataFrame, rename_map: dict, report_path: str, title: str):
    ...
    try:
        ...
        with open(report_path, 'w', encoding='utf-8') as f:
            ...
            output_file = report_path.replace('_report.txt', '.parquet').replace('reports', 'data/known_drugs')
