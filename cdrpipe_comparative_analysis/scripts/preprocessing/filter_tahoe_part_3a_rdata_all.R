#!/usr/bin/env Rscript
#' Tahoe Signatures Part 3a: All Experiments to RData
#'
#' Converts ranked parquet data to RData for all Tahoe experiments.
#' Creates large-scale signature matrix for comprehensive drug discovery analysis.
#'
