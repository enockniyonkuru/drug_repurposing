...
Example usage:
python scripts/analysis/extract_pipeline_results_analysis.py \
    --input_dir creeds_diseases/results/creed_manual_standardised_results_OG_exp_8 \
    --output_dir creeds_diseases/analysis/creed_manual_analysis_exp_8
