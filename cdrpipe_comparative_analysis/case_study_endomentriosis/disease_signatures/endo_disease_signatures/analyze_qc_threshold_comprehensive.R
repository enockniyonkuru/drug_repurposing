...
sig_stats <- read.csv('threshold_analysis/signature_statistics.csv')

# Read one signature file to understand gene-level filtering
example_sig <- read.csv('endo_disease_sigatures_standardized/tomiko_dvc_esesamples_signature.csv')
...
ggsave("threshold_analysis/signature_median_logfc_thresholds.png", p,
       width = 10, height = 12, dpi = 300)

cat('\n\nVisualization saved to: threshold_analysis/signature_median_logfc_thresholds.png\n')
