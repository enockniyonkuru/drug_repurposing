...
disease_dir <- "case_study_endomentriosis/disease_signatures/endo_disease_signatures/the_6_tomiko_study_v3/6_tomiko_disease_signatures_v3"
...
# Save summary
out_file <- "case_study_endomentriosis/disease_signatures/endo_disease_signatures/genes_retained_threshold85.csv"
