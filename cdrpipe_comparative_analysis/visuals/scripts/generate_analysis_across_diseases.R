#!/usr/bin/env Rscript
# ============================================================================
# Generate Endometriosis Reversal Heatmap: Precision and Recall Performance
#
# Outputs (to visuals/figures/analysis_across_diseases/):
...
#
# Data source:
#   - tahoe_cmap_analysis/data/analysis/Exp8_Analysis.xlsx  (sheet "exp_8_0.05")
# ============================================================================
...
data_file  <- file.path(repo_root, "tahoe_cmap_analysis", "data", "analysis", "Exp8_Analysis.xlsx")
output_dir <- file.path(repo_root, "visuals", "figures", "analysis_across_diseases")
dir.create(output_dir, showWarnings = FALSE, recursive = TRUE)

# Load raw data
df <- read_excel(data_file, sheet = "exp_8_0.05")
