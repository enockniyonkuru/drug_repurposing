...
#
# Outputs (to visuals/figures/platform_comparison/):
...
#
# Data sources:
#   - tahoe_cmap_analysis/data/drug_signatures/cmap/cmap_signatures.RData
#   - tahoe_cmap_analysis/data/drug_signatures/tahoe/tahoe_signatures.RData
#   - tahoe_cmap_analysis/data/drug_signatures/cmap/cmap_drug_experiments_new.csv
#   - tahoe_cmap_analysis/data/drug_signatures/cmap/cmap_valid_instances_OG_015.csv
#   - tahoe_cmap_analysis/data/disease_signatures/creeds_manual_disease_signatures/*_signature.csv
#   - tahoe_cmap_analysis/data/known_drugs/known_drug_info_data.parquet
#   - tahoe_cmap_analysis/data/drug_signatures/tahoe/tahoe_drug_experiments_new.csv
# ============================================================================
...
output_dir <- file.path(repo_root, "visuals", "figures", "platform_comparison")
dir.create(output_dir, showWarnings = FALSE, recursive = TRUE)

data_dir <- file.path(repo_root, "tahoe_cmap_analysis", "data")
...
cmap_exp_all <- read.csv(file.path(data_dir, "drug_signatures", "cmap", "cmap_drug_experiments_new.csv"))
cmap_valid   <- read.csv(file.path(data_dir, "drug_signatures", "cmap", "cmap_valid_instances_OG_015.csv"))
...
known_drugs <- read_parquet(file.path(data_dir, "known_drugs", "known_drug_info_data.parquet"))
cmap_drugs   <- read.csv(file.path(data_dir, "drug_signatures", "cmap", "cmap_drug_experiments_new.csv"))
tahoe_drugs  <- read.csv(file.path(data_dir, "drug_signatures", "tahoe", "tahoe_drug_experiments_new.csv"))
