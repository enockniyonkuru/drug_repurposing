...
Outputs:
  - visuals/figures/drug_class_distributions/cmap_drug_target_classes.png
  - visuals/figures/drug_class_distributions/tahoe_drug_target_classes.png
  - visuals/figures/drug_class_distributions/disease_therapeutic_areas.png

Data sources (relative to repository root):
  - tahoe_cmap_analysis/case_study_special/case_study_disease_category/about_drugs/open_target_drugs_in_cmap.csv
  - tahoe_cmap_analysis/case_study_special/case_study_disease_category/about_drugs/open_target_drugs_in_tahoe.csv
  - tahoe_cmap_analysis/case_study_special/case_study_disease_category/about_diseases/creeds_diseases_with_known_drugs.csv
"""
...
# ---------------------------------------------------------------------------
REPO_ROOT = Path(__file__).resolve().parents[2]  # visuals/scripts -> repo root

DATA_DIR = REPO_ROOT / "tahoe_cmap_analysis" / "case_study_special" / "case_study_disease_category"
OUTPUT_DIR = REPO_ROOT / "visuals" / "figures" / "drug_class_distributions"
...
# ---------------------------------------------------------------------------
print("Loading data...")
cmap_drugs = pd.read_csv(DATA_DIR / "about_drugs" / "open_target_drugs_in_cmap.csv")
tahoe_drugs = pd.read_csv(DATA_DIR / "about_drugs" / "open_target_drugs_in_tahoe.csv")
diseases = pd.read_csv(DATA_DIR / "about_diseases" / "creeds_diseases_with_known_drugs.csv")
