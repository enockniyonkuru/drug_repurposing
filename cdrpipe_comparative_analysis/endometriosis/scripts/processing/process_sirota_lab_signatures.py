#!/usr/bin/env python3
"""
Process Sirota Lab Disease Signatures

Converts and standardizes disease signatures from Sirota Lab Excel and CSV files.
...
def main():
    ...
    source_dir = os.path.join(project_root, 'data', 'disease_signatures', 'old_sirota_lab_signatures')
    
    # New directory for standardized output files
    output_dir = os.path.join(project_root, 'case_study_endomentriosis', 'disease_signatures', 'sirota_lab_disease_signatures')
