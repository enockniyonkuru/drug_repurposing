...
#
# Outputs (to visuals/figures/disease_signature_analysis/):
...
#
# Data sources:
#   - tahoe_cmap_analysis/data/disease_signatures/creeds_manual_disease_signatures_standardised/*_signature.csv
#   - tahoe_cmap_analysis/data/disease_signatures/creeds_disease_gene_counts_across_stages.csv
# ============================================================================
...
output_dir <- file.path(repo_root, "visuals", "figures", "disease_signature_analysis")
dir.create(output_dir, showWarnings = FALSE, recursive = TRUE)

sig_dir <- file.path(repo_root, "tahoe_cmap_analysis", "data",
                     "disease_signatures", "creeds_manual_disease_signatures_standardised")
gene_counts_file <- file.path(repo_root, "tahoe_cmap_analysis", "data",
                              "disease_signatures", "creeds_disease_gene_counts_across_stages.csv")
