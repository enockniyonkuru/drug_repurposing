...
# Save
ggsave("tahoe_cmap_analysis/figures/Figure_3_Raw_Data.pdf", combined_figure, width = 16, height = 5, dpi = 300)
ggsave("tahoe_cmap_analysis/figures/Figure_3_Raw_Data.png", combined_figure, width = 16, height = 5, dpi = 300)

cat("\n✓ Figure 3 created and saved:\n")
cat("  - tahoe_cmap_analysis/figures/Figure_3_Raw_Data.pdf\n")
cat("  - tahoe_cmap_analysis/figures/Figure_3_Raw_Data.png\n")
