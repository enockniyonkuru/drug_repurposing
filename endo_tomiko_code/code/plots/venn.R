...
eulerr_options(
  fills = list(fill = 
                 c("slategray1","plum2","lightpink","lightskyblue","lemonchiffon1")
  ),
  labels = list(fontsize = 15),
  quantities = list(fontsize = 15),
  main = list(fontsize = 16)
  )
...
plot(
  ...
  shape = "circle"),
  quantities = T,
  fill = c("lemonchiffon1", "slategray1","plum2"),
  main = "")
...
plot(
  ...
  shape = "circle"),
  quantities = T,
  fill = c("lemonchiffon1","lightskyblue"),
  main = "")
