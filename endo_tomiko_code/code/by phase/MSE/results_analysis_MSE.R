...
load("~/Desktop/endometriosis/by phase/MSE/results.RData")  #pipeline results
...
write.csv(drug_instances, "~/Desktop/endometriosis/by phase/MSE/drug_instances_MSE.csv")
...
write.csv(drug_dz_signature, "~/Desktop/endometriosis/by phase/MSE/drug_dz_signature_MSE.csv")
...
pdf(("~/Desktop/endometriosis/by phase/MSE/heatmap_cmap_hits_MSE.pdf"), width = 12, height = 15)
layout(matrix(1))
par(mar=c(6, 4, 1, 0.5))
colPal <- redblue(100)
