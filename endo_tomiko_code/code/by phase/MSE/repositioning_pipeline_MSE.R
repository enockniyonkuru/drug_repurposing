...
dataset <- "endo"
dz_signature <- read.csv("~/Desktop/endometriosis/by phase/MSE/rawdata.csv")
...
subset_comparison_id <- paste0("MSE_", dataset)
analysis_id <- "cmap"
...
save(results, file = "~/Desktop/endometriosis/by phase/MSE/results.RData")
