...
dataset <- "endo"
dz_signature <- read.csv("~/Desktop/endometriosis/by phase/PE/rawdata.csv")
...
subset_comparison_id <- paste0("PE_", dataset)
analysis_id <- "cmap"
...
save(results, file = "~/Desktop/endometriosis/by phase/PE/results.RData")
