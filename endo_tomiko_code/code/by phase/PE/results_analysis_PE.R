...
load("~/Desktop/endometriosis/by phase/PE/results.RData")  #pipeline results
...
write.csv(drug_instances, "~/Desktop/endometriosis/by phase/PE/drug_instances_PE.csv")
...
write.csv(drug_dz_signature, "~/Desktop/endometriosis/by phase/PE/drug_dz_signature_PE.csv")
...
pdf(("~/Desktop/endometriosis/by phase/PE/heatmap_cmap_hits_PE.pdf"), width = 12, height = 15)
layout(matrix(1))
par(mar=c(6, 4, 1, 0.5))
colPal <- redblue(100)
