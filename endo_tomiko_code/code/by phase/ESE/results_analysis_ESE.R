...
load("~/Desktop/endometriosis/by phase/ESE/results.RData")  #pipeline results
...
write.csv(drug_instances, "~/Desktop/endometriosis/by phase/ESE/drug_instances_ESE.csv")
...
write.csv(drug_dz_signature, "~/Desktop/endometriosis/by phase/ESE/drug_dz_signature_ESE.csv")
...
pdf(("~/Desktop/endometriosis/by phase/ESE/heatmap_cmap_hits_ESE.pdf"), width = 12, height = 15)
layout(matrix(1))
par(mar=c(6, 4, 1, 0.5))
colPal <- redblue(100)
