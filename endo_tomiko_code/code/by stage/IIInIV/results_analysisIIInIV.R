...
load("~/Desktop/endometriosis/by stage/IIInIV/results.RData")  #pipeline results
load('~/Desktop/endometriosis/cmap data/cmap_signatures.RData')   #cmap_signatures
cmap_experiments <- read.csv("~/Desktop/endometriosis/cmap data/cmap_drug_experiments_new.csv", stringsAsFactors =  F) #cmap profiles metadata
valid_instances <- read.csv("~/Desktop/endometriosis/cmap data/cmap_valid_instances.csv", stringsAsFactors = F)
...
write.csv(drug_instances, "~/Desktop/endometriosis/by stage/IIInIV/drug_instances_IIInIV.csv")
...
write.csv(drug_dz_signature, "~/Desktop/endometriosis/by stage/IIInIV/drug_dz_signature_IIInIV.csv")
...
pdf(("~/Desktop/endometriosis/by stage/IIInIV/heatmap_cmap_hits_IIInIV.pdf"), width = 12, height = 15)
layout(matrix(1))
par(mar=c(6, 4, 1, 0.5))
colPal <- redblue(100)
