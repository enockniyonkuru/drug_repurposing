...
dz_signature <- read.csv("~/Desktop/endometriosis/code/by stage/InII/Stages I-II vs Control_Dan.csv") ## (TO)
...
write.csv(rand_cmap_scores,"~/Desktop/endometriosis/code/by stage/InII/rand_cmap_scores.csv",row.names=TRUE) ##(TO)
...
save(results, file = "~/Desktop/endometriosis/code/by stage/InII/results.RData") ##(TO)
