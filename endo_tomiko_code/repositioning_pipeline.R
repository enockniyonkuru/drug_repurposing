...
# Case study: COVID-19
#
# Component #2: Apply drug repositioning pipeline to transcriptomic sPTB signature
...
subset_comparison_id <- paste0("unstratified_", dataset)
analysis_id <- "cmap"
...
save(results, file = "~/Desktop/endometriosis/code/unstratified/results.RData")
