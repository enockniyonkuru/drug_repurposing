#####################################################################
# END-TO-END PIPELINE: STAGES ONLY (IIInIV and InII)
# Using rawdata.csv with seed(2009) for reproducibility
#####################################################################
...
cat("\n")
cat("════════════════════════════════════════════════════════════════\n")
cat("END-TO-END PIPELINE: STAGES (IIInIV & InII)\n")
cat("════════════════════════════════════════════════════════════════\n\n")

# Define stage signatures with their correct raw data paths
signatures <- list(
  list(name = "IIInIV", 
       rawdata_path = "~/Desktop/endo_tomiko_code/code/by stage/IIInIV/rawdata.csv",
       output_dir = "~/Desktop/endo_tomiko_code/replication/end_to_end_IIInIV_v2"),
  list(name = "InII", 
       rawdata_path = "~/Desktop/endo_tomiko_code/code/by stage/InII/rawdata.csv",
       output_dir = "~/Desktop/endo_tomiko_code/replication/end_to_end_InII_v2")
)
