...
#' @param probe_id_key character or \code{NULL}; optional column name containing
#'   probe identifiers to use as a fallback mapping source when gene-symbol
#'   conversion fails.
#' @param probe_id_fallback logical; if \code{TRUE}, try fallback probe-ID based
#'   matching for genes that do not map through g:Profiler.
#'
