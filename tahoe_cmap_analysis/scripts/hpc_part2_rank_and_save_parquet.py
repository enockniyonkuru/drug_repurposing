#!/usr/bin/env python3
"""
HPC PART 2 (FIX): Rank and Save Checkpoint
===========================================
Loads the intermediate parquet from the HPC Part 1, re-runs the
transpose, mapping, and ranking, and saves the final ranked matrix
as a new, stable parquet checkpoint.

This avoids the pyreadr error from the original script.
"""
...
def main():
    ...
    logging.info("="*80)
    logging.info("HPC Pipeline - Part 2 (FIX): Rank and Save Parquet")
    logging.info("="*80)
    ...
    try:
        ...
        logging.info("  ⚠️  This is the memory bottleneck!")
