#!/usr/bin/env python3
"""
Filter pipeline results to only include shared drugs between CMAP and TAHOE.

This script:
1. Loads the list of shared drugs
2. Processes all CSV files in the results directory
3. Filters each file to only include drugs that are in the shared list
4. Saves filtered results to a new directory
"""
