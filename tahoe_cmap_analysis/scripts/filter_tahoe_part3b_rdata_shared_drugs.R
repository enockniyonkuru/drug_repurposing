#!/usr/bin/env Rscript
# TAHOE PART 3b: Create RData (Shared Drugs Only)
# Converts ranked parquet to RData format for 13,500 shared drug experiments.
# Input: tahoe_ranked_shared_genes_all_drugs.parquet (from Part 2)
# Output: tahoe_genes_drugs.RData (~45 MB, 12,544 genes × 13,500 signatures)
# Runtime: ~1 minute
