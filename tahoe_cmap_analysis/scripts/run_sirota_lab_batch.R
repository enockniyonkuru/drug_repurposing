...
disease_dir <- "/Users/enockniyonkuru/Desktop/drug_repurposing/tahoe_cmap_analysis/data/disease_signatures/sirota_lab_disease_signatures"
...
# Common parameters
cmap_valid <- NULL
out_root <- "/Users/enockniyonkuru/Desktop/drug_repurposing/tahoe_cmap_analysis/results/sirota_lab_disease_results_filtered"
...
cat("Found", length(disease_files), "SIROTA LAB disease signature files\n\n")
