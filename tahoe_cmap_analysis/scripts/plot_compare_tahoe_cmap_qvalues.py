#!/usr/bin/env python3
"""
Compare CMAP vs TAHOE Results Across Diseases
==============================================
This script compares CMAP and TAHOE results across multiple diseases to determine
if the q=0 issue is TAHOE-specific, disease-specific, or a global pipeline issue.

Outputs:
1. Summary CSV with statistics for each disease/dataset combination
2. Comparison plots for each disease
3. Diagnostic summary report
"""
