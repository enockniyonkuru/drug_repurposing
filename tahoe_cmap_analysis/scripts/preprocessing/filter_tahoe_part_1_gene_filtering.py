#!/usr/bin/env python3
"""
Tahoe Signatures Part 1: Filter to Shared Genes

Filters raw Tahoe H5 data to include only genes present in both CMAP and Tahoe.
Produces intermediate parquet file for ranking step. Optimized for HPC
processing of large expression matrices.
"""
import os
import gc
import numpy as np
