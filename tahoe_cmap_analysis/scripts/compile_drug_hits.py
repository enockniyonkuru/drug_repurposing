#!/usr/bin/env python3
"""
Script to compile drug repurposing results from multiple experiments.
Creates two output files:
1. all_drug_hits_compiled.csv - All drug hits with disease and signature type
2. drug_hits_summary.csv - Summary statistics by disease
"""
