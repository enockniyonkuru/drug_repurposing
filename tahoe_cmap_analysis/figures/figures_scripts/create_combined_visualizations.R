...
# SAVE ALL VERSIONS
# ============================================================
ggsave("tahoe_cmap_analysis/figures/Option1_Grouped_Bar_Chart.pdf", 
        plot1, width = 11, height = 7, dpi = 300, bg = "#FAFAFA")
ggsave("tahoe_cmap_analysis/figures/Option1_Grouped_Bar_Chart.png", 
        plot1, width = 11, height = 7, dpi = 300, bg = "#FAFAFA")

ggsave("tahoe_cmap_analysis/figures/Option2_Lollipop_Chart.pdf", 
        plot2, width = 11, height = 7, dpi = 300, bg = "#FAFAFA")
ggsave("tahoe_cmap_analysis/figures/Option2_Lollipop_Chart.png", 
        plot2, width = 11, height = 7, dpi = 300, bg = "#FAFAFA")

ggsave("tahoe_cmap_analysis/figures/Option3_DotPlot_With_Lines.pdf", 
        plot3, width = 11, height = 7, dpi = 300, bg = "#FAFAFA")
ggsave("tahoe_cmap_analysis/figures/Option3_DotPlot_With_Lines.png", 
        plot3, width = 11, height = 7, dpi = 300, bg = "#FAFAFA")

ggsave("tahoe_cmap_analysis/figures/Option4_Faceted_Columns.pdf", 
        plot4, width = 11, height = 7, dpi = 300, bg = "#FAFAFA")
ggsave("tahoe_cmap_analysis/figures/Option4_Faceted_Columns.png", 
        plot4, width = 11, height = 7, dpi = 300, bg = "#FAFAFA")
