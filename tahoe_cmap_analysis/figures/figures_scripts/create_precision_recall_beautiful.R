...
# Save combined
ggsave("tahoe_cmap_analysis/figures/Precision_Recall_Combined_Beautiful.pdf", 
        combined, width = 10, height = 10, dpi = 300, bg = "#FAFAFA")
ggsave("tahoe_cmap_analysis/figures/Precision_Recall_Combined_Beautiful.png", 
        combined, width = 10, height = 10, dpi = 300, bg = "#FAFAFA")

# ============ INDIVIDUAL PRECISION PLOT ============
ggsave("tahoe_cmap_analysis/figures/Precision_by_Match_Type_Beautiful.pdf", 
        plot1, width = 9, height = 6, dpi = 300, bg = "#FAFAFA")
ggsave("tahoe_cmap_analysis/figures/Precision_by_Match_Type_Beautiful.png", 
        plot1, width = 9, height = 6, dpi = 300, bg = "#FAFAFA")

# ============ INDIVIDUAL RECALL PLOT ============
ggsave("tahoe_cmap_analysis/figures/Recall_by_Match_Type_Beautiful.pdf", 
        plot2, width = 9, height = 6, dpi = 300, bg = "#FAFAFA")
ggsave("tahoe_cmap_analysis/figures/Recall_by_Match_Type_Beautiful.png", 
        plot2, width = 9, height = 6, dpi = 300, bg = "#FAFAFA")
