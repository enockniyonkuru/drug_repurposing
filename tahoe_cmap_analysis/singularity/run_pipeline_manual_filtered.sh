#!/bin/bash
### ============================================================
### UCSF Wynton HPC Submission Script — DRpipe: CREEDS Manual
### ============================================================
...
#$ -j y
#$ -r y
#$ -N drpipe_manual           # Job name (unique for this run)
...
### --- Logging setup ---
JOB_NAME=${JOB_NAME:-drpipe_manual}
...
echo "=============================================================="
echo "🚀 Starting DRpipe Batch Analysis: CREEDS MANUAL"
echo "Node: $(hostname)"
...
### --- Run the R Script ---
echo "Starting Rscript for CREEDS MANUAL..."
Rscript ${R_SCRIPT} \
  ...
  --out_root "../results/creeds_manual_disease_results" \
